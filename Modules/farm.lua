return {
    start = function(GUI, spn)
        ...
        ft.Text = "МОЛОТ v8.1" ft.TextColor3 = C.white ft.Font = Enum.Font.GothamBold ft.TextSize = 12 ft.TextXAlignment = Enum.TextXAlignment.Left
        ...
        local hi = Instance.new("TextLabel", pg) hi.Size = UDim2.new(1,0,0,14) hi.Position = UDim2.new(0,0,0,162) hi.BackgroundTransparency = 1
        hi.Text = "⚠️ Если сломалось - перезайди" hi.TextColor3 = Color3.fromRGB(255,180,50) hi.Font = Enum.Font.Gotham hi.TextSize = 9 hi.TextXAlignment = Enum.TextXAlignment.Center
        ...
        hb.MouseButton1Click:Connect(function()
            ...
            if ho then
                ...
                coroutine.wrap(function() while ho do smash() hits = hits + 1 sl.Text = "Hits: "..hits.." | Broken: "..bro.." | Auto: "..cyc wait(0.3) end end)()
        ...
        ab.MouseButton1Click:Connect(function()
            ...
            if ao then
                ...
                coroutine.wrap(function()
                    while ao do
                        local c = getCar()
                        if not c then cl.Text = "🚗 Респавн..." spn.click() wait(3)
                        else local d = false for i=1,20 do if not ao then break end d = smash() hits = hits + 1 sl.Text = "Hits: "..hits.." | Broken: "..bro.." | Auto: "..cyc if d then break end wait(0.2) end
                        if d then cyc = cyc + 1 sl.Text = "Hits: "..hits.." | Broken: "..bro.." | Auto: "..cyc cl.Text = "💀 Уничтожена!" wait(1) cl.Text = "🚗 Респавн..." spn.click() wait(3) end end
                    end
                end)()
